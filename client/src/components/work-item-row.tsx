      ...
      {isExpanded && (
        <>
          ...
          <div className="grid grid-cols-12 gap-0 mb-2">
            ...
            <div className="col-span-1 text-xs text-muted-foreground font-medium text-center leading-tight -ml-[40px] mt-[60px]">
              <div className="ml-[30px] mr-[40px]">Дни</div>
              <div className="ml-[20px] mr-[20px]">рабочие</div>
            </div>
            <div className="col-span-1 text-xs text-muted-foreground font-medium text-center leading-tight -ml-[120px] mt-[60px]">
              <div className="ml-[40px] mr-[40px]">Дни</div>
